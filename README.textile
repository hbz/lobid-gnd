...
Get the GND RDF/XML source data (for the @2018_10@ release here, find current at "https://data.dnb.de/opendata/":https://data.dnb.de/opendata/):

@cd GND ; wget https://data.dnb.de/opendata/T{b,f,g,n,p,s,u}gesamt2018_10gnd.rdf.gz@

This should give you 7 local files ending with '.rdf.gz'. You can configure locations in 'conf/application.conf'.
