...
Get the EntityFacts data from the DNB – for the @20191013@ release here, find current at "https://data.dnb.de/opendata/":https://data.dnb.de/opendata/:

@wget https://data.dnb.de/opendata/authorities_entityfacts_20191013.jsonld.gz@

Unpack the data:

@gunzip < authorities_entityfacts_20191013.jsonld.gz > authorities_entityfacts_20191013.jsonld@
...
@data { ... entityfacts: "entityfacts/authorities_entityfacts_20191013.jsonld" ...@

Set up the name for the index to create in 'conf/application.conf' (index.entityfacts.index):

@index { ... entityfacts { index: "entityfacts_20191013" ...@
...
Get the GND RDF/XML source data – for the @20191013@ release here, find current at "https://data.dnb.de/opendata/":https://data.dnb.de/opendata/:

@wget https://data.dnb.de/opendata/authorities-{geografikum,koerperschaft,kongress,name,person,sachbegriff,werk}_lds_20191013.rdf.gz@
...
@sbt "runMain apps.ConvertUpdates 2019-10-13"@
