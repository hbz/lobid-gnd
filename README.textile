...
"!https://github.com/hbz/lobid-gnd/workflows/Scala%20CI/badge.svg?branch=master!":https://github.com/hbz/lobid-gnd/actions?query=workflow%3AScala%20CI
...
Get the EntityFacts data from the DNB – for the @20200713@ release here, find current at "https://data.dnb.de/opendata/":https://data.dnb.de/opendata/:

@wget https://data.dnb.de/opendata/authorities_entityfacts_20200713.jsonld.gz@
