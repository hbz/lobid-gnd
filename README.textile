...
Prerequisites: @sbt 0.13@ or newer &mdash; "download sbt":http://www.scala-sbt.org/download.html
...
Fully rebuild the index data from the input files in @test/ttl@:

@rm -rf data/ ; rm GND.jsonl ; sbt test@
