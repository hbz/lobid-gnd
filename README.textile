...
Get the EntityFacts data from the DNB:
...
@data { ... entityfacts: "entityfacts/authorities_entityfacts.jsonld" ...@

Set up the name for the index to create in 'conf/application.conf' (index.entityfacts.index):

@index { ... entityfacts { index: "entityfacts-20190816-1500" ...@
...
@sbt "runMain apps.ConvertUpdates 2019-06-13"@
